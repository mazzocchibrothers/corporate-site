        ...
        <section id="context-section" className="section-breathe relative py-16 lg:py-20" style={{ background: '#F7F7F7' }}>
          <div className="max-w-[1400px] mx-auto px-5 md:px-8 lg:px-12">
            ...
            <Section className="mb-24">
              ...
              <h2 className="text-[clamp(1.3rem,2vw,1.8rem)] font-semibold text-[#121212] leading-[1.5] mb-14">{c.challenge.title}</h2>
            ...
            <Section>
              <div className="rounded-2xl border border-[#4b4df7]/[0.12] bg-gradient-to-br from-[#4b4df7]/[0.04] to-transparent p-10">
                ...
                <h2 className="text-[clamp(1.8rem,3vw,2.5rem)] font-semibold text-[#121212] leading-[1.4] mb-4 leading-[1.3]">{c.vision.title}</h2>
