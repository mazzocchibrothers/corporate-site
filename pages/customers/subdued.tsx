              ...
              <div className="lg:col-span-8">
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.3 }}>
                  <h1 className="text-[clamp(2.2rem,4.5vw,3.8rem)] font-bold tracking-[-0.03em] text-white/95 mb-8" style={{ lineHeight: 1.12 }}>
                    Winning Gen Z talent.<br />Without drowning in interviews.
                  </h1>
                  ...
                  <div className="border-l-2 border-[#4B4DF7]/30 pl-6">
                    <p className="text-[17px] text-white/[0.65] italic leading-[1.7]">"It not only improves the quality of my work, it makes us very attractive to candidates. The innovation of the selection process became a genuine element of Employer Branding."</p>
                    <p className="text-[14px] text-white/50 mt-3 font-semibold">Valentina Cianciaruso, <span className="font-normal text-white/35">HR Manager Dept. Italy, Subdued</span></p>
                  </div>
                </motion.div>
              </div>
              ...
              <div className="grid lg:grid-cols-3 gap-4 mb-10">
                {[
                  ...
                  <div key={s.step} className="rounded-xl border border-[#4B4DF7]/[0.08] bg-white/60 p-6">
                    ...
                    <h4 className="text-[16px] font-bold text-[#1A1A2E] mb-2">{s.title}</h4>
                    <p className="text-[14px] text-[#1A1A2E]/50 leading-[1.6]">{s.desc}</p>
                  </div>
                ))}
              </div>
              <div className="border-l-2 border-[#4B4DF7]/20 pl-6 max-w-3xl">
                <p className="text-[15px] text-[#1A1A2E]/50 italic leading-[1.7]">"Using Skillvue for competency evaluation at the pre-screening stage, I managed to reduce time-to-hire, maintain a direct relationship with candidates, and recover precious time for strategic activities I previously had to sacrifice."</p>
                ...
                <div className="grid lg:grid-cols-3 gap-6">
                  {[
                    ...
                    <div key={r.icon} className="rounded-xl bg-white/[0.04] p-6">
                      <h4 className="text-[16px] font-bold text-white/90 mb-3">{r.icon}</h4>
                      <p className="text-[14px] text-white/[0.65] leading-[1.7]">{r.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
              <div className="border-l-2 border-[#4B4DF7]/20 pl-6 max-w-3xl">
                <p className="text-[15px] text-[#1A1A2E]/50 italic leading-[1.7]">"I no longer have to squeeze one interview after another into my calendar. At first I had some doubts about such advanced technology, but I immediately understood that it not only improves my work quality. it made us very attractive to our candidates."</p>
                <p className="text-[13px] text-[#1A1A2E]/40 mt-2 font-semibold">Valentina Cianciaruso</p>
              </div>
            </Section>
