...
export const getStaticProps = messagesFor('customers/eataly-3');
...
const CHALLENGE_BUSINESS_CHALLENGES = [
  { id: 'paceExpansionDemanded', icon: Zap },
  { id: 'searchWasChallenging', icon: Layers },
  { id: 'growthDemandedEven', icon: TrendingUp },
];

const CHALLENGE_HR_CHALLENGES = [
  { id: 'newMoreData', icon: Eye },
  { id: 'softSkillsHad', icon: CheckCircle },
  { id: 'despitePaceFeedback', icon: Heart },
];

const OBJECTIVES_ITEMS = [
  { id: 'mapAllKey', icon: Eye },
  { id: 'maintainingHighStandard', icon: Scale },
  { id: 'integrateAiHuman', icon: Heart },
  { id: 'processApplicationsLess', icon: Zap },
];
...
export default function EatalyStoryPage() {
  ...
  return (
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-16">
              ...
              <div className="lg:col-span-7">
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.3 }}>
                  ...
                  <p className="text-[16px] text-white/[0.60] leading-[1.75] mb-10 max-w-2xl">{t('subtitle')}</p>
    ...
    b: (chunks) => <strong className="text-[#121212]/80 font-semibold">{chunks}</strong>,
              ...
              {t.has('solution.intro2') && <p className="text-[16px] text-[#121212]/[0.65] leading-[1.8] mb-12">{t.rich('solution.intro2', {
    b: (chunks) => <strong className="text-[#121212]/80 font-semibold">{chunks}</strong>,
  })}</p>}
              <div>
    ...
    b: (chunks) => <strong className="text-[#121212]/80 font-semibold">{chunks}</strong>,
                ...
                {t.has('vision').nextGen && <p className="text-[16px] text-[#121212]/[0.65] leading-[1.8] mt-4">{t.raw('vision').nextGen}</p>}
              </div>
            </Section>
