          ...
          <div className="grid lg:grid-cols-12 gap-16 lg:gap-20 items-start">
            ...
            <div className="lg:col-span-5">
              ...
              <p className="text-[18px] text-white/[0.55] leading-[1.75] max-w-md" style={{ fontWeight: 300 }}>
                Prenota un incontro con il nostro team per scoprire come Skillvue può trasformare i tuoi processi di selezione, performance e sviluppo grazie alla dati chiari e oggettivi supportati dalla scienza.
              </p>
            </div>
