      ...
      <div className="max-w-[1400px] mx-auto px-8 lg:px-12">
        ...
        >
          <h2 className="text-[clamp(1.8rem,3.5vw,3.5rem)] font-bold leading-[1.05] tracking-[-0.03em] text-white/90 max-w-4xl">
            Ready to make talent decisions{' '}
            <span className="italic font-bold gradient-text">you can defend?</span>
          </h2>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative">
              <span className="text-[15px] font-bold text-[#9B9DFB]/[0.65] tracking-[0.1em] uppercase">Ready to explore</span>
              ...
              <p className="text-[17px] text-white/[0.65] mb-8 max-w-md">
                See Skillvue live with your specific use case
              </p>
              <a
                href="/book-meeting"
          ...
          >
            <span className="text-[15px] font-bold text-[#9B9DFB]/[0.65] tracking-[0.1em] uppercase mb-10 block">Our Customers</span>
