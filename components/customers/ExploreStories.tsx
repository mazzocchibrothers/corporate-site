...
const allStories = [
  ...
  },
  {
    ...
    headlineIt: "Come In's Mercato ha costruito una pipeline interna di Store Manager",
    headlineEn: "How In's Mercato built an internal pipeline of Store Managers",
  ...
  },
  {
    ...
    headlineIt: 'Come ADR ha costruito la talent pipeline per un aeroporto che raddoppia',
    headlineEn: 'How ADR built the talent pipeline for an airport that doubles in size',
  ...
  },
  {
    ...
    headlineIt: 'Come Unicomm sta costruendo una nuova gestione del talento su una rete di 270 punti vendita in costante aumento',
    headlineEn: 'How Unicomm is building a new talent management system across a network of 270 stores and growing',
    bgImage: '/logos/unicomm-background-explore-stories.jpg',
  },
  {
    id: 'mediaset', company: 'Mediaset', industry: 'Media & Telecom', useCases: ['Hiring'],
    headlineIt: 'Come selezionare e far crescere il talento su scala in un gruppo che sta triplicando le dimensioni',
    headlineEn: 'How to select and grow talent at scale in a group that is tripling in size',
  ...
  },
  {
    ...
    headlineIt: 'Come ottenere un tasso di successo delle assunzioni del 76% in un business fondato sulla componente umana',
    headlineEn: 'How to achieve a 76% hiring success rate in a business built on human interaction',
  ...
  },
  {
    ...
    headlineIt: 'Come Douglas ha mappato le competenze di 2.200 persone su 370 store in sole 5 settimane',
    headlineEn: 'How Douglas mapped the skills of 2,200 people across 370 stores in just 5 weeks',
