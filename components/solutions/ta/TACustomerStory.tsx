      ...
      <div className="max-w-[1400px] mx-auto px-8 lg:px-12">
        ...
        >
          ...
          <div className="lg:col-span-8 p-10 lg:p-14 bg-white/[0.04]">
            ...
            <p className="text-[14px] text-white/40 mb-8">Luxury & Retail</p>

            <div className="grid md:grid-cols-2 gap-8 mb-10">
              <div>
                <span className="text-[11px] font-bold text-white/30 tracking-[0.1em] uppercase mb-3 block">Challenge</span>
                <p className="text-[15px] text-white/[0.65] leading-[1.75]">Scaling global hiring across 50+ roles while maintaining consistent luxury brand standards.</p>
              </div>
              <div>
                <span className="text-[11px] font-bold text-[#9B9DFB]/50 tracking-[0.1em] uppercase mb-3 block">Result</span>
                <p className="text-[15px] text-white/[0.65] leading-[1.75]">From 500 to 10,000 candidates assessed per year. A single objective standard now applies across all markets and geographies.</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 flex flex-col items-center justify-center p-10 lg:p-14 bg-white/[0.06] border-t lg:border-t-0 lg:border-l border-white/[0.06]">
            ...
            <p className="text-[14px] text-white/[0.65] mt-4 text-center">candidates assessed<br />per year</p>
            <div className="mt-6 flex items-center gap-2">
              <div className="h-px w-8 bg-white/10" />
              <span className="text-[11px] text-white/30">20x growth</span>
              <div className="h-px w-8 bg-white/10" />
            </div>
          </div>
        </motion.div>
