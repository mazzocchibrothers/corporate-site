    ...
    <section id="pm-hero" data-testid="pm-hero" className="relative min-h-screen flex flex-col justify-center pt-[80px]">
      <div className="max-w-[1400px] mx-auto px-8 lg:px-12 w-full py-16 lg:py-0">
        ...
        >
          ...
          <span className="italic font-bold gradient-text">{t('opinions?')}</span>
        </motion.h1>
        <motion.div
        ...
        >
          <p className="text-[16px] lg:text-[18px] text-white/[0.65] leading-[1.75] max-w-xl" style={{ fontWeight: 300 }}>
            {t('Skillvue integrates objective skill assessments into your performance cycles. reducing bias, improving calibration, and giving every manager a data-backed starting point before they write a single review.')}
          </p>
