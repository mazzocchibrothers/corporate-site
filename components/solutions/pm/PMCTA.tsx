    ...
    <section id="pm-cta" data-testid="pm-cta" className="section-breathe relative py-20 lg:py-24" ref={ref}>
      <div className="max-w-[1400px] mx-auto px-8 lg:px-12">
        <motion.div className="mb-12" initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7 }}>
          <h2 className="text-[clamp(1.8rem,3.5vw,3rem)] font-semibold leading-[1.05] tracking-[-0.02em] text-[#121212]">{t.rich('pmcta.heading', {
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7, delay: 0.2 }}>
          <Button asChild variant="primary" mode="light" className="w-full md:w-auto max-w-xl">
            <a href={href('book-meeting', lang)} data-testid="pm-final-cta">
              <span>{t('pmcta.cta')}</span>
