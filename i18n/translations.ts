...
export const translations = {
  ...
  'Skillvue is the objective skills data layer for your enterprise, tailored to your competency framework, grounded in science, scaled by AI, embedded into the HR systems you already run, so every talent decision, from hiring to transformation, is finally the right one.': "Skillvue è il livello dati sulle competenze della tua azienda, su misura per il tuo framework di competenze, fondato sulla scienza, scalato dall'AI, integrato nei sistemi HR che già utilizzi, affinché ogni decisione sul talento — dall'hiring alla trasformazione — sia finalmente quella giusta.",
  'ABOUT SKILLVUE': 'ABOUT SKILLVUE',
  'Founded in Milan in 2021, Skillvue is building the Skills Operating System for talent decisions: the objective skills data layer that maps the skills an organisation needs, measures people against them with science, and feeds that intelligence into the HR systems companies already use. Every talent decision, from hiring to internal mobility to transformation, finally rests on evidence instead of gut feel.': "Fondata a Milano nel 2021, Skillvue sta costruendo il sistema operativo delle competenze per le decisioni sui talenti: lo strato oggettivo di dati sulle competenze che mappa le skill di cui un'organizzazione ha bisogno, le misura con metodo scientifico e alimenta quell'intelligenza nei sistemi HR già in uso. Ogni decisione sui talenti, dall'assunzione alla mobilità interna fino alla trasformazione, si basa finalmente su evidenze invece che sull'istinto.",
  'Backed by €9M from investors including 360 Capital, 14Peaks Capital and the Italian Founders Fund, Skillvue serves large European enterprises across banking, retail and pharma, with more than a million people already assessed. The platform pairs I/O psychology and psychometrics with generative AI, and it is built for European enterprise from day one: ISO/IEC 27001 certified, GDPR compliant, and designed around the EU AI Act.': "Con 9 milioni di euro raccolti da investitori tra cui 360 Capital, 14Peaks Capital e Italian Founders Fund, Skillvue serve grandi aziende europee nei settori bancario, retail e farmaceutico, con oltre un milione di persone già valutate. La piattaforma abbina la psicologia I/O e la psicometria all'intelligenza artificiale generativa, ed è costruita per le imprese europee fin dal primo giorno: certificata ISO/IEC 27001, conforme al GDPR e progettata in linea con l'EU AI Act.",
  'Behind it sits a team of 50+ people across Milan, London and Berlin, supported by a science network of 50+ external collaborators from academia and industry, bringing together artificial intelligence, people science and enterprise readiness.': "Dietro tutto questo c'è un team di oltre 50 persone tra Milano, Londra e Berlino, supportato da una rete scientifica di oltre 50 collaboratori esterni provenienti dal mondo accademico e industriale, che unisce intelligenza artificiale, scienze delle persone e preparazione enterprise.",
  ...
  'Meet Our Founders': 'Incontra i Nostri Fondatori',
  '"We set out to make talent decisions as rigorous as every other business decision"': '"Ci siamo prefissati di rendere le decisioni sul talento rigorose quanto qualsiasi altra decisione aziendale"',
  'Co-founder & CEO': 'Co-founder & CEO',
  'After competing at a pre-Olympic level in sports at a very young age, Nicolò found himself at a crossroads: a career as a professional sailor, with the dream of the Olympics, or a more conventional university education and career. After a year of reflection in Australia, he chose a third way: to set up his own business, founding his first startup in the B2C entertainment sector with his brother Riccardo. After this first successful experience, he decided to move into the HR Tech sector and, together with his partner Simone Patera, launched Skillvue with the aim of leveraging AI technology to support companies in human capital management and in the transition towards a skills-based approach.': "Dopo aver gareggiato a livello pre-olimpico nello sport in giovane età, Nicolò si è trovato a un bivio: una carriera come velista professionista con il sogno delle Olimpiadi, oppure un percorso universitario e professionale più convenzionale. Dopo un anno di riflessione in Australia, ha scelto una terza via: avviare una propria impresa, fondando la sua prima startup nel settore B2C dell'intrattenimento insieme al fratello Riccardo. Dopo questa prima esperienza di successo, ha deciso di entrare nel settore HR Tech e, insieme al suo socio Simone Patera, ha lanciato Skillvue con l'obiettivo di sfruttare la tecnologia AI per supportare le aziende nella gestione del capitale umano e nella transizione verso un approccio basato sulle competenze.",
  "Simone started his first company in the education sector when he was just 18 years old, and led its growth to a team of 50 people, while completing his studies in Philosophy. After graduating, he worked as a Business Developer for various Italian companies in the tech sector, collaborating with major players such as Poste Italiane and Rai. During those years, he also became father to two girls. In 2021 his professional path crossed with Nicolò Mazzocchi's: from the union of their respective experiences in the startup and technology field, Skillvue was born.": "Simone ha fondato la sua prima azienda nel settore dell'istruzione a soli 18 anni, portandola a crescere fino a un team di 50 persone mentre completava i suoi studi in Filosofia. Dopo la laurea, ha lavorato come Business Developer per diverse aziende italiane del settore tech, collaborando con player di primo piano come Poste Italiane e Rai. In quegli anni è anche diventato padre di due figlie. Nel 2021 il suo percorso professionale si è incrociato con quello di Nicolò Mazzocchi: dall'unione delle loro rispettive esperienze nel mondo delle startup e della tecnologia, è nata Skillvue.",
  'OUR TEAM': 'IL NOSTRO TEAM',
  'One Team, Multiple Disciplines, One Mission': "Un Team, Molteplici Discipline, Un'Unica Missione",
  'Psychometricians': 'Psicometristi',
  'Engineers': 'Ingegneri',
  'Designers': 'Designer',
  'Join us →': 'Unisciti a noi →',
  'Life at Skillvue': 'La vita in Skillvue',
  '50+ people across Milan, Paris, Berlin & London.': '50+ persone tra Milano, Parigi, Berlino e Londra.',
  ...
  'People across Europe': 'Persone in tutta Europa',
  'Offices in Milan, Paris, Berlin, London': 'Uffici a Milano, Parigi, Berlino, Londra',
  'Hybrid': 'Ibrido',
  ...
  'A short Skillvue verification of skills, mindset and readiness.': 'Una breve valutazione Skillvue di competenze, mindset e readiness.',
  'Meet the team': 'Incontra il team',
  "Structured, fair conversations with the people you'd actually work with.": 'Colloqui strutturati ed equi con le persone con cui lavorerai davvero.',
