...
export const translations = {
  ...
  // Science Hero
  'Science you can stake': 'Scienza su cui puoi',
  'on.': 'basare le tue decisioni',

  // ===== PRESS PAGE =====
  'Press': 'Stampa',
  'Skillvue in': 'Skillvue sulla',
  'the News': 'stampa',
  "See how the world's leading publications are covering the rise of AI-powered talent intelligence.": "Scopri cosa dicono alcune delle principali testate italiane e internazionali sull'ascesa della talent intelligence guidata da scienza ed AI.",
  'Press Coverage': 'Rassegna Stampa',
  'Coverage from leading publications': 'Skillvue sui media esteri',
  'Interviews': 'Interviste',
  'In conversation': 'Interviste',
