...
export const translations = {
  ...
  'People across Europe': 'Persone in Europa',
  'People empowered': 'Persone supportate',
  'Unlock human potential and': 'Sblocca il potenziale umano e',
  'organizational success at scale': 'il successo organizzativo su scala',
  'OUR VISION': 'LA NOSTRA VISIONE',
  'A world where every talent decision, from hire to promotion to transformation is powered by objective intelligence. Where human potential is no longer left to chance. And organizational success is something you build, not hope for.': "Un mondo in cui ogni decisione sul talento — dall'assunzione alla promozione fino alla trasformazione — è alimentata dall'intelligenza oggettiva. Dove il potenziale umano non è più lasciato al caso. E il successo organizzativo è qualcosa che si costruisce, non si spera.",
  'WHO WE ARE': 'CHI SIAMO',
  'Skillvue is the': 'Skillvue è il',
  'Skills Operating System': 'Skills Operating System',
  ...
  'Founded in 2021, Skillvue is an Italian HR-tech startup with a fast-growing team that has doubled in size over the past year, bringing together experts in psychometrics, AI, product design, and enterprise go-to-market across Milan, London, Berlin, and Paris.': "Fondata nel 2021, Skillvue è una startup italiana di HR-tech con un team in rapida crescita, raddoppiato nell'ultimo anno, che riunisce esperti di psicometria, AI, product design e go-to-market enterprise tra Milano, Londra, Berlino e Parigi.",
  'We have built a product that combines psychometric rigour with modern AI. Our system transforms static data into predictive insights, driving smarter decisions across hiring and talent management. We support mid-to-large enterprises across Europe (1,000+ employees) working across a wide range of industries, where talent decisions are high-stakes and expensive.': "Abbiamo costruito un prodotto che combina il rigore psicometrico con la moderna AI. Il nostro sistema trasforma dati statici in insight predittivi, guidando decisioni più intelligenti in ambito hiring e talent management. Supportiamo imprese di medie e grandi dimensioni in tutta Europa (1.000+ dipendenti) in numerosi settori, dove le decisioni sul talento sono ad alto rischio e ad alto costo.",
