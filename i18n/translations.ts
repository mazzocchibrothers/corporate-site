...
export const translations = {
  ...
  'AI-powered verifications predict on-the-job performance before you make an offer. Stop gambling on interviews.': "Le valutazioni basate su AI predicono le performance lavorative prima di fare un'offerta. Porta maggiore oggettività nella selezione.",
  ...
  'AI-powered verifications that predict job success, not just screen CVs.': 'Valutazioni basate su AI che predicono il successo lavorativo, non solo screening di CV.',
  ...
  'Every verification, tailored.': 'Ogni valutazione, su misura.',
  ...
  'A single objective standard now applies across all markets and geographies. from 500 to 10,000 candidates verified per year.': 'Un unico standard oggettivo ora si applica su tutti i mercati e le geografie. da 500 a 10.000 candidati valutati all\'anno.',
  'time-to-hire': 'time-to-hire',
  'volume of verifications': 'volume di valutazioni',
  ...
  'Structured competency verification': 'Valutazione strutturata delle competenze',
  ...
  // ===== HOW IT WORKS - STEPS =====
  'Step': 'Passo',
  'From verification': 'Dalla valutazione',
  'to action': "all'azione",
  'From verification to action': "Dalla valutazione all'azione",
  'in three steps': 'in tre passi',
  'Map': 'Mappa',
  'Predict': 'Prevedi',
  'Decide': 'Decidi',
  'Verify skills, mindset, and readiness across candidates and employees using AI-powered psychometric verifications, customized to your leadership model and deployable at scale across 50+ languages.': 'Valuta competenze, mentalità e prontezza tra candidati e dipendenti usando valutazioni psicometriche basate su AI, personalizzate sul tuo modello di leadership e implementabili su scala in oltre 50 lingue.',
  ...
  'Having a consistent skills verification, from external hiring to internal growth, meant delivering concrete solutions to our real challenges.': 'Avere una valutazione omogenea delle competenze, dalla selezione esterna alla crescita interna, per noi ha significato dare soluzioni concrete ai nostri problemi',
  ...
  'More candidates objectively verified without adding headcount': 'Più candidati valutati oggettivamente senza aggiungere personale',
  ...
  '~900 people verified. A Store Manager pipeline built from within.': '~900 persone valutate. Una pipeline di Store Manager costruita dall interno.',
  ...
  "Replace gut-feel interviews with AI-powered verifications that predict on-the-job performance. Scalable from 10 to 10,000 candidates. same scientific rigor at every level.": "Sostituisci i colloqui basati sull'intuito con valutazioni AI che predicono la performance lavorativa. Scalabile da 10 a 10.000 candidati. Stesso rigore scientifico a ogni livello.",
  'Explore Talent Acquisition': 'Esplora Talent Acquisition',
  'Add an objective layer to performance cycles. Structured competency verifications reduce bias, improve calibration, and give managers a starting point grounded in data, not recency.': "Aggiungi un livello oggettivo ai cicli di performance. Le valutazioni strutturate riducono i bias, migliorano la calibrazione e danno ai manager un punto di partenza basato sui dati.",
  ...
  'Verification Design': 'Design della Valutazione',
  ...
  'Verification Generation': 'Generazione Valutazioni',
  'We create verifications skill by skill. deeply contextualized to your roles and framework.': 'Creiamo valutazioni competenza per competenza, con una profonda contestualizzazione con i tuoi ruoli e framework.',
  'AI-generated items, expert validation, continuous adaptation': 'Item generati da AI, validazione esperti, adattamento continuo',
  'Verification Delivery': 'Erogazione Valutazioni',
  ...
  // ===== PRODUCT - ASSESSMENT FORMATS =====
  'Verifications designed to surface': 'Valutazioni progettate per far emergere',
  'Verification designed to surface': 'Verification costruiti per far emergere le vere',
  'verified capabilities': 'capacità',
  'How is the verification delivered': "Come viene costruito l'verification",
  ...
  'Free-text responses for handling writing-heavy skills or allowing in-room verifications': 'Risposte a testo libero per gestire competenze che richiedono molta scrittura o per verification svolti in ufficio',
  ...
  'How the verification is delivered': "Come viene erogato l'verification",
  'Verification Method': 'Metodo di Valutazione',
  ...
  "Evaluates objective eligibility: qualifications, availability, logistics, baseline requirements. A structured screening layer before deeper verification.": "Valuta l'idoneità oggettiva: qualifiche, disponibilità, logistica, requisiti di base. Uno screening strutturato prima di valutazioni più approfondite.",
  ...
  'Predicts capacity to grow, adapt, and take on greater complexity. Verified through three validated dimensions: learning agility, intrinsic motivation, and career aspiration.': "Predice la capacità di crescere, adattarsi e affrontare maggiore complessità. Valutata attraverso tre dimensioni validate: agilità di apprendimento, motivazione intrinseca e aspirazione.",
  ...
  'Same scientific rigor whether you verify 10 or 10,000 candidates': 'Stesso rigore scientifico che tu valuti 10 o 10.000 candidati',
  ...
  'AI-powered skill verifications from the top of the funnel': "Valutazioni delle competenze basate su AI dall'inizio del funnel",
  ...
  'Short verifications on suitability and killer skills via web app or WhatsApp. Reduce manual effort, accelerate pre-selection, filter for objective eligibility before deeper verification.': "Brevi valutazioni su idoneità e competenze chiave via web app o WhatsApp. Riduci lo sforzo manuale, accelera la pre-selezione, filtra per idoneità oggettiva.",
  'Verifications on soft skills, hard skills, potential, and traits. Standardized evaluation that removes bias and produces comparable, predictive shortlists.': 'Valutazioni su soft skill, hard skill, potenziale e tratti. Valutazione standardizzata che rimuove i bias e produce shortlist comparabili e predittive.',
  'Deep verifications on potential, traits, and skills for professional+ roles. Cross-job insights, detailed candidate profiles, and in-person interview support packages.': "Valutazioni approfondite su potenziale, tratti e competenze per ruoli professional+. Insight cross-ruolo, profili candidato dettagliati e pacchetti di supporto per colloqui.",
  'matters': 'conta',
  ...
  'opinions?': 'opinioni?',
  "Skillvue integrates objective skill verifications into your performance cycles. reducing bias, improving calibration, and giving every manager a data-backed starting point before they write a single review.": "Skillvue integra valutazioni oggettive delle competenze nei tuoi cicli di performance riducendo i bias, migliorando la calibrazione e dando a ogni manager un punto di partenza basato sui dati prima di scrivere una singola review.",
  ...
  'cross-team comparability without structured verification': 'comparabilità cross-team in assenza di verification strutturati',
  ...
  'Subjective verifications': 'Valutazioni soggettive',
  ...
  'Objective verifications': 'Valutazioni oggettive',
  ...
  'Combining subjective verification methods with Skillvue verifications brings objectivity without compromising on context and nuance.': "Combinare metodi di valutazione soggettivi con le valutazioni Skillvue porta oggettività senza compromettere contesto e sfumature.",
  ...
  'Skill verifications embedded in performance reviews with the same objectivity as business metrics': 'Valutazioni delle competenze integrate nelle performance review con la stessa oggettività delle metriche aziendali',
  'Customer Story': 'Storia Cliente',
  'Financial Services': 'Servizi Finanziari',
  'Challenge': 'Sfida',
  'Result': 'Risultato',
  'Introducing objective competency verification into performance cycles across multiple countries and business units.': 'Introduzione della valutazione oggettiva delle competenze nei cicli di performance in più paesi e business unit.',
  'A unified talent language across hiring, performance, and development for the first time. Verifications now inform decisions from screening to succession.': 'Un linguaggio del talento unificato tra selezione, performance e sviluppo per la prima volta. Le valutazioni ora informano le decisioni dallo screening alla successione.',
  ...
  'Pre/post verification comparison. Objective tracking of progress and concrete impact on performance.': 'Confronto valutazione pre/post. Tracciamento oggettivo dei progressi e impatto concreto sulle performance.',
  ...
  'Organizations spend billions on talent yet still rely on gut feeling for their most important people decisions. We are changing that. one verification at a time.': 'Le organizzazioni spendono miliardi sul talento eppure si affidano ancora alle sensazioni per le decisioni più importanti sulle persone. Noi stiamo cambiando questo. una valutazione alla volta.',
  ...
  'Enterprise clients': 'Aziende partner',
  'Languages supported': 'Lingue supportate',
  'Verifications delivered': 'Valutazioni erogate',
  ...
  'I/O psychology grounds our platform in decades of research on human performance at work, ensuring we map the right skills, select the right constructs, and use the right mix of verification types for each talent decision.': "La psicologia I/O fonda la nostra piattaforma su decenni di ricerca sulle performance umane al lavoro, garantendo che si mappino le competenze giuste, si selezionino i costrutti giusti e si utilizzi il mix giusto di tipi di verification per ogni decisione sul talento.",
  'Psychometrics': 'Psicometria',
  'Defining how to measure it right': 'Definire come misurare correttamente',
  'Psychometrics governs the design of every verification we build: which format, which scale, which scoring model. The goal is simple: maximize accuracy, minimize noise, and make sure results mean what they claim to mean.': "La psicometria governa il design di ogni verification che costruiamo: quale formato, quale scala, quale modello di scoring. L'obiettivo è semplice: massimizzare l'accuratezza, minimizzare il rumore e assicurare che i risultati significhino ciò che dichiarano di significare.",
  ...
  'Design verification items': 'Progettare gli item di verification',
  ...
  'We embed verification science into the product so rigor scales with the system. Clear constructs, evidence-centered design, and governed scoring prevent AI from introducing noise.': "Integriamo la migliore scienza dell'verification nel prodotto per permetterti di scalare con rigore. Costrutti chiari, design centrato sulle evidenze e scoring controllato impediscono all'AI di introdurre bias.",
  ...
  'Computational psychologist with double Ph.D. degrees and hands-on experience in Machine Learning and AI-based verification. His interdisciplinary background brings a unique perspective to the verification field, combining psychological knowledge with advanced AI and machine learning techniques. At Skillvue, he leads the AI & Science team, innovating, validating and implementing new competency verification models built on the latest technologies.': "Doppio dottore di ricerca e psicologo computazionale con esperienza pratica nel campo del Machine Learning e degli verification basati su AI. Grazie al suo background interdisciplinare, porta una prospettiva unica nell'ambito verification, combinando conoscenze psicologiche con avanzate tecniche di AI e machine learning. In Skillvue guida il team AI & Science, innovando, validando e implementando nuovi modelli di verification delle competenze basati sulle tecnologie più recenti.",
  'Computational psychologist with double Ph.D. degrees. Combines psychological knowledge with advanced AI and ML techniques to innovate, validate and implement new skills verification models.': "Psicologo computazionale con doppio dottorato. Combina conoscenze psicologiche con tecniche avanzate di AI e ML per innovare, validare e implementare nuovi modelli di verification delle competenze.",
  'Jatin Babbar': 'Jatin Babbar',
  'Senior ML Engineer': 'Senior ML Engineer',
  "Builds and optimizes the machine learning systems that power Skillvue's verification engine, working at the intersection of NLP, psychometrics, and production AI.": "Costruisce e ottimizza i sistemi di machine learning che alimentano il motore di verification di Skillvue, lavorando all'intersezione tra NLP, psicometria e AI in produzione.",
  'Dr. Serena Dolfi, Ph.D.': 'Dr. Serena Dolfi, Ph.D.',
  'People Scientist': 'People Scientist',
  'Psychologist specializing in psychometric verification design and validation. Leads the development of competency frameworks and ensures scientific integrity across all verification products.': "Psicologa specializzata in design e validazione di verification psicometrici. Guida lo sviluppo dei framework di competenze e assicura l'integrità scientifica in tutti i prodotti di verification.",
  'Wamiq Raza': 'Wamiq Raza',
  'ML Engineer': 'ML Engineer',
  'Develops and maintains the core ML pipeline, focusing on model training, evaluation, and deployment for real-time verification scoring.': "Sviluppa e mantiene la pipeline ML core, focalizzandosi su training, valutazione e deploy dei modelli per lo scoring degli verification in tempo reale.",
  ...
  'AI recommends; humans decide. HR teams can edit, override, and make the final call on every verification.': "L'AI consiglia; gli umani decidono. I team HR possono modificare, sovrascrivere e prendere la decisione finale su ogni verification.",
  ...
  'questions': '',
  'questions.': 'frequenti.',
  'How does Skillvue ensure verification validity?': 'Come fa Skillvue a garantire la validità degli verification?',
  'Every verification is built on validated I-O psychology constructs, reviewed by subject-matter experts, piloted with real participants, and continuously monitored for reliability and fairness. We publish internal validity reports for every deployment.': "Ogni verification è costruito su costrutti validati di psicologia I/O, revisionato da esperti di settore, testato con partecipanti reali e monitorato continuamente per affidabilità ed equità. Pubblichiamo report interni di validità per ogni implementazione.",
  'What role does AI play in verification design and scoring?': "Che ruolo ha l'AI nel design e nello scoring degli verification?",
  'AI generates contextualized verification items, scores responses with transparent evidence, and surfaces patterns at scale. But every AI output is governed by psychometric constraints and subject to human review.': "L'AI genera item di verification contestualizzati, valuta le risposte con evidenze trasparenti e identifica pattern su scala. Ma ogni output dell'AI è governato da vincoli psicometrici e soggetto a revisione umana.",
  'How does Skillvue handle bias in verifications?': 'Come gestisce Skillvue i bias negli verification?',
  ...
  'Skillvue verifications are available in 50+ languages, with cultural adaptation built into the item design process to ensure measurement consistency across regions.': "Gli verification Skillvue sono disponibili in oltre 50 lingue, con adattamento culturale integrato nel processo di design degli item per garantire coerenza di misurazione tra le diverse regioni.",
  ...
  // Science Methodology
  'A rigorous, end-to-end verification': 'Un verification rigoroso per gestire un',
  'lifecycle': 'lifecycle end-to-end',
  'Deploy at scale': 'Deploy su scala',
  'Verifications delivered via web, WhatsApp, Teams, Slack — in 50+ languages with consistent measurement quality.': 'Verification erogati via web, WhatsApp, Teams, Slack in 50+ lingue con la stessa consistenza qualitativa',
  ...
  'Verify more candidates, verify them more deeply, or do it faster. but never all three at once.': 'Valutare più candidati, valutarli più in profondità, o farlo più velocemente. ma mai tutte e tre le cose insieme.',
  'Carrefour Italia is extending the Skillvue verification framework to internal mobility. using the same skills language built for recruitment to identify internal candidates for promotion and lateral moves across the 3 sales channels.': "Carrefour Italia sta estendendo il framework di verification Skillvue alla mobilità interna. usando lo stesso linguaggio di competenze costruito per il recruiting per identificare candidati interni per promozioni e movimenti laterali attraverso i 3 canali di vendita.",
  'The challenge': 'La Sfida',

  // Subdued
  'Winning Gen Z talent.': 'Conquistare i talenti della Gen Z.',
  'Without drowning in interviews.': 'Senza affogare nei colloqui.',
  'In fashion retail, turnover is structurally high and Gen Z candidates bring strong instincts but limited CV depth. For Store Managers and Sales Assistants, what matters most. communication, selling, teamwork. is invisible on a CV. The only way to verify it was interviews, creating an unsustainable equation for a lean HR team.': "Nel fashion retail, il turnover è strutturalmente alto e i candidati Gen Z portano forte intuito ma poca profondità nel CV. Per Store Manager e Sales Assistant, ciò che conta di più. comunicazione, vendita, lavoro di squadra. è invisibile nel CV. L'unico modo per valutarlo erano i colloqui, creando un'equazione insostenibile per un team HR snello.",
  ...
  'Skillvue enabled a structured verification based on the soft skill framework Ins had already built for the Store Manager profile. ~1,000 employees verified via mobile in ~30 minutes during work hours.': "Skillvue ha permesso una valutazione strutturata basata sul framework di soft skill che In's aveva già costruito per il profilo Store Manager. ~1.000 dipendenti valutati via mobile in ~30 minuti durante l'orario di lavoro.",
  ...
  'Soft skills verified': 'Soft skill valutate',
  'profiles': 'profili',
  ...
  // Methodology cards
  'Mobile-first verification': 'Verification da mobile',
  ...
  // Funnel
  'Involved': 'Coinvolti',
  'Verifications completed': 'Verification completati',
  // Impact cards
  ...
  // Vision bullets
  'Same criteria and competency framework from hiring to development: new hires are verified from day one with the same logic used to develop them': 'Stessi criteri e stesso framework di competenze dalla selezione allo sviluppo: chi entra viene già valutato con la logica con cui verrà accompagnato domani',
  "Verification via WhatsApp: in grocery retail this isn't a convenience choice, it's a strategic one. It removes every barrier to access and drives completion rates that other tools can't match": "Verification via WhatsApp: nella GDO non è una scelta di comodo, è una scelta strategica. Abbatte ogni barriera di accesso e porta i tassi di completamento a livelli che altri strumenti non raggiungono",
  'Extending verification to current Store Managers to identify profiles ready for the Area Manager role': 'Estensione della valutazione agli Store Manager in carica, per identificare i profili pronti al ruolo di Area Manager',
  ...
  // ===== ABOUT PAGE (CURRENT) =====
  'About Us – Skillvue': 'Chi Siamo – Skillvue',
  'Learn about Skillvue, the Skills Operating System for modern enterprises. Our mission, vision, founders, and team.': 'Scopri Skillvue, lo Skills Operating System per le grandi imprese. La nostra missione, visione, fondatori e team.',
  'Unlock human potential and': 'Sblocchiamo il potenziale delle',
  'organizational success at scale': 'persone per guidare il successo della tua organizzazione su larga scala',
  'OUR VISION': 'LA NOSTRA VISIONE',
  'A world where every talent decision, from hire to promotion to transformation is powered by objective intelligence. Where human potential is no longer left to chance. And organizational success is something you build, not hope for.': "Un mondo in cui ogni decisione sui talenti, dall'assunzione alla promozione fino allo sviluppo, è guidata da un'intelligenza oggettiva. Dove il potenziale umano non è più lasciato al caso, e il successo organizzativo è qualcosa che viene costruita, anziché atteso.",
  'WHO WE ARE': 'CHI SIAMO',
  'Skillvue is the': 'Skillvue è il',
  'Skills Operating System': 'sistema operativo delle competenze',
  'for your organization.': 'per la tua organizzazione.',
  'Skillvue is the objective skills data layer for your enterprise, tailored to your competency framework, grounded in science, scaled by AI, embedded into the HR systems you already run.': "Skillvue è il data layer oggettivo sulle competenze progettato su misura per la tua organizzazione, fondato sulla scienza, scalabile grazie all’AI e integrabile nei tuoi sistemi HR che già utilizzi.",
  "We work with the world's leading organizations.": 'Lavoriamo con le organizzazioni leader a livello mondiale.',
  'We enable global enterprises to access predictive data on talent, grounded in science and scaled by AI, so every decision about people is based on evidence, not intuition.': "Permettiamo alle grandi aziende globali di accedere a dati predittivi sul talento, fondati sulla scienza e scalati dall'AI, affinché ogni decisione sulle persone si basi su evidenze, non sull'intuito.",
  ...
  'in every organization': 'in ogni organizzazione',
  'Building the science-grounded, AI-scaled Skills Operating System that every HR system can plug into, so that every talent decision, from hire to promotion to transformation, is finally objective.': "Costruiamo lo Skills Operating System fondato sulla scienza e scalato dall'AI, a cui ogni sistema HR può connettersi, affinché ogni decisione sul talento — dall'assunzione alla promozione fino alla trasformazione — sia finalmente obiettiva.",
  'Meet Our Founders': 'Conosci i nostri fondatori',
  '"We set out to make talent decisions as rigorous as every other business decision"': '"Ci siamo posti l\'obiettivo di rendere le decisioni sul talento rigorose quanto le decisioni più strategiche dell\'azienda".',
  'Co-founder & CEO': 'Co-founder & CEO',
  'After competing at a pre-Olympic level in sports at a very young age, Nicolò found himself at a crossroads: a career as a professional sailor, with the dream of the Olympics, or a more conventional university education and career. After a year of reflection in Australia, he chose a third way: to set up his own business, founding his first startup in the B2C entertainment sector with his brother Riccardo. After this first successful experience, he decided to move into the HR Tech sector and, together with his partner Simone Patera, launched Skillvue with the aim of leveraging science and AI to support companies in human capital management and in the transition towards a skills-based approach.': "Dopo un'esperienza sportiva a livelli pre-olimpici da giovanissimo, Nicolò si trova davanti a un bivio: la carriera da velista professionista, con il sogno delle Olimpiadi, o un percorso universitario e lavorativo più canonico. Dopo un anno di riflessione in Australia, sceglie una terza via: mettersi in proprio, fondando la sua prima startup nel settore dell'entertainment B2C con il fratello Riccardo. Dopo questa prima esperienza di successo, decide di spostarsi nel settore HR Tech e, insieme al socio Simone Patera, lancia Skillvue con l'obiettivo di mettere le nuove tecnologie di AI al servizio delle aziende impegnate nello sviluppo del proprio capitale umano e nella trasformazione dei propri modelli organizzativi in chiave skills-based.",
  'A former pre-Olympic-level athlete turned entrepreneur, Nicolò co-founded Skillvue with Simone Patera after an early B2C entertainment venture, with the goal of bringing science and AI to human capital management and the shift toward a skills-based approach.': "Ex atleta di livello pre-olimpico diventato imprenditore, Nicolò ha co-fondato Skillvue con Simone Patera dopo una prima esperienza in un'azienda di entertainment B2C, con l'obiettivo di portare scienza e AI nella gestione del capitale umano e nella transizione verso un approccio skills-based.",
  "Simone is the co-founder of Skillvue. He started his first company in the education sector when he was just 18 years old, and led its growth to a team of 50 people, while completing his studies in Philosophy. After graduating, he worked as a Business Developer for various Italian companies in the tech sector, collaborating with major players such as Poste Italiane and Rai. During those years, he also became father to two girls. In 2021 his professional path crossed with Nicolò Mazzocchi's: from the union of their respective experiences in the startup and technology field, Skillvue was born.": "Simone è Co-founder di Skillvue. Ha avviato la sua prima azienda nel settore dell'educazione a soli 18 anni, guidandone la crescita fino a un team di 50 persone, mentre completava gli studi in Filosofia. Dopo la laurea, ha lavorato come Business Developer per diverse realtà italiane nel settore tech, collaborando con grandi player come Poste Italiane e Rai. In quegli anni, è anche diventato papà di due bambine. Nel 2021 inizia a collaborare con Nicolò Mazzocchi: dall'unione delle rispettive esperienze in ambito startup e tecnologico nasce Skillvue, a cui entrambi decidono di dedicarsi completamente.",
  'Simone co-founded Skillvue, drawing on a background that began with launching an education company at 18 and grew through business development roles in Italian tech alongside players like Poste Italiane and Rai.': "Simone ha co-fondato Skillvue, forte di un percorso iniziato con il lancio di un'azienda nel settore dell'educazione a 18 anni e proseguito in ruoli di business development nel tech italiano, al fianco di realtà come Poste Italiane e Rai.",
  'OUR TEAM': 'IL NOSTRO TEAM',
  'One Team, Multiple Disciplines, One Mission': 'Un team. Più discipline. Una missione.',
  'One Team One Mission': 'Un team, una missione',
  'People. Data. Performance. One engine for the future of work.': 'Persone. Dati. Performance. Un unico motore per il futuro del lavoro.',
  "One team across Europe at the intersection of Organizational and Psychometric Science, AI, and Data Science shipping cutting-edge AI Agents that measure what actually matters: what people can do, not what their title says. High ambition, high standards, zero complacency. We push boundaries daily and settle for nothing less than excellence. Talent is the world's most underused asset. We're here to unlock all of it and leave a mark doing it.": "Un unico team in tutta Europa, all'intersezione tra scienza organizzativa e psicometrica, AI e data science, che sviluppa AI Agent all'avanguardia capaci di misurare ciò che conta davvero: cosa sanno fare le persone, non cosa dice il loro ruolo. Grande ambizione, standard elevati, zero compiacimento. Superiamo i limiti ogni giorno e non ci accontentiamo di nulla che non sia eccellenza. Il talento è la risorsa più sottoutilizzata al mondo. Siamo qui per liberarlo tutto e lasciare il segno.",
  'Working with leading global companies': 'Al fianco delle aziende leader a livello globale',
  'Backed by leading European VCs': 'Sostenuti dai principali VC europei',
  ...
  // ===== CAREERS PAGE =====
  'Careers': 'Carriere',
  'Join the team making talent decisions': 'Entra nel team che rende le decisioni sul talento',
  'objective.': 'oggettive.',
  "You'll help the world's biggest companies hire, promote and develop people based on skills and potential.": "Aiuterai le più grandi aziende del mondo ad assumere, promuovere e sviluppare le persone in base alle competenze e al potenziale.",
  'See open roles': 'Vedi le posizioni aperte',
  'People across Europe': 'Persone in tutta Europa',
  'Offices in Milan, Berlin, London': 'Uffici a Milano, Berlino, Londra',
  'Hybrid': 'Ibrido',
  'Working environment': 'Ambiente di lavoro',
  'People empowered': 'Persone valorizzate',
  'Why Skillvue': 'Perché Skillvue',
  'Every talent decision, from hiring to transformation, is': "Ogni decisione sul talento, dall'assunzione alla trasformazione, è",
  'finally the right one': 'finalmente quella giusta',
  'We are building the objective skills data layer for the enterprise, grounded in science and scaled by AI.': "Stiamo costruendo lo strato oggettivo di dati sulle competenze per le aziende, fondato sulla scienza e scalato dall'intelligenza artificiale.",
  'How we hire': 'Come selezioniamo',
  'We hire the way we help': 'Selezioniamo come aiutiamo',
  'enterprises hire': 'le aziende a selezionare',
  'Our own hiring reflects the same principles we bring to our customers: a skills-based method, not CV screening.': 'La nostra selezione riflette gli stessi principi che portiamo ai nostri clienti: un metodo basato sulle competenze, non sulla scrematura dei CV.',
  'Apply with your skills': 'Candidati con le tue competenze',
  'A short Skillvue verification of your skills, mindset and readiness.': 'Una breve valutazione Skillvue delle tue competenze, mindset e readiness.',
  'Meet the team': 'Incontra il team',
  "Structured conversations with the people you'd actually work with.": 'Colloqui strutturati con le persone con cui lavorerai davvero.',
  'Move forward with clarity': 'Vai avanti con chiarezza',
  'An objective, bias-free, explainable decision. For you and for us.': 'Una decisione oggettiva, priva di bias e spiegabile. Per te e per noi.',
  'Skills-first': 'Competenze al centro',
  'Bias-free': 'Senza bias',
  'GDPR-compliant': 'Conforme al GDPR',
  'Explainable': 'Spiegabile',
  'Flexible and hybrid working environment': 'Ambiente di lavoro flessibile e ibrido',
  'Join us!': 'Unisciti a noi!',
  'Open roles': 'Posizioni aperte',
  'Apply': 'Candidati',
  'No roles match this filter.': 'Nessuna posizione corrisponde a questo filtro.',
  "Don't see your role?": 'Non trovi il ruolo che cerchi?',
  'Submit an open application': 'Invia una candidatura spontanea',
  'Ready to do the most important work in HR tech?': "Pronto a fare il lavoro più importante nell'HR tech?",
};
