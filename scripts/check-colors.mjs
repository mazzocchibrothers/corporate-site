...
//   #2d2d2d, #cbcbcb
//             The day-to-day quote cards' border and secondary name text,
//             taken directly from the Figma component (node 695:2140).
const ALLOWED = new Set(
  (
    ...
    '#22c55e #23234d #2a2350 #2d1a6b #2d2d2d #3133e7 #3a1525 #3a1730 #4b4b4b #4b4df7 #4e4e4e #4e6bff #5667ff ' +
    '#5ddba4 #6366f8 #6b7dff #7577f8 #7a7a7a #7b4dff #7b7df9 #8385ff #848484 #8587ff #888888 #8a8cff ' +
    '#9395ff #93e0bb #9a9a9a #9b59b6 #9b9dfb #a8ecca #a9a9a9 #a9aaff #b7f5d8 #c7d2fe #cbcbcb #cdc6f5 ' +
