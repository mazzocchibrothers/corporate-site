...
import { ArrowLeft, ArrowRight, Clock, BookOpen, Heart, Users, Handshake, Target, Brain, RefreshCw, Wrench, Shield, Calendar, Compass } from 'lucide-react';
...
export default async function BlogArticle8() {
  const locale = await getLocale();
  const t = await getTranslations('blog.social-skills');
