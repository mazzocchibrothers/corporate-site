...
export default function Mediaset2StoryPage() {
  ...
  const t = useTranslations('customers.mediaset-2');
      ...
      <main>
        ...
        <section className="relative pt-[80px] min-h-screen flex items-center">
          <div className="absolute inset-0 overflow-hidden">
            <img src="/logos/customer-story-cover-mediaset.avif" alt="" className="absolute inset-0 w-full h-full object-cover" style={{ filter: 'blur(8px) brightness(0.25)', transform: 'scale(1.1)' }} />
          ...
          <div className="relative z-10 w-full max-w-[1400px] mx-auto px-5 md:px-8 lg:px-12 py-8 lg:py-10">
            ...
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
              ...
              <Reveal y={0} x={20} duration={0.6} delay={0.5} className="lg:col-span-4 flex flex-col gap-4">
                ...
                <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-sm px-5 py-4">
                  <p className="text-[24px] font-medium text-white leading-[1.4] italic mb-5 pb-5 border-b border-white/[0.08]">"{t('quote.text')}"</p>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[12px] font-semibold text-white/70">{t('quote.author')}</p>
                      <p className="text-[11px] text-white/35 leading-[1.4]">{t('quote.role')}</p>
                    </div>
                  </div>
                </div>
              </Reveal>
    ...
    br: () => <br />,
            ...
            <Section className="mb-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
                {[
                  { ...t.raw('results.metrics')[0], Icon: Users },
                  { ...t.raw('results.metrics')[1], Icon: Smile },
                  { ...t.raw('results.metrics')[2], Icon: TrendingUp },
                ].map((m) => (
