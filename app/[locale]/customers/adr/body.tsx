...
const CHALLENGE_BUSINESS_CHALLENGES = [
  { id: 'potentialNearly4', icon: Users },
  { id: 'developmentPipelineWas', icon: TrendingUp },
  { id: 'withoutClearPaths', icon: Scale },
];

const CHALLENGE_HR_CHALLENGES = [
  { id: 'topDownApproach', icon: Eye },
  { id: 'democratisationDevelopmentAt', icon: BarChart3 },
  { id: 'complianceRequiredStronger', icon: Shield },
];

const OBJECTIVES_ITEMS = [
  { id: 'makePotentialVisible', icon: Users },
  { id: 'guideDecisionsScience', icon: Target },
  { id: 'scaleWithoutAdding', icon: Zap },
  { id: 'buildHumanLoop', icon: Layers },
];
      ...
      <main>
        ...
        <section className="relative pt-[80px] min-h-screen flex items-center">
          ...
          <div className="relative z-10 w-full max-w-[1400px] mx-auto px-5 md:px-8 lg:px-12 py-8 lg:py-10">
            {/* Breadcrumb */}
            <Reveal y={0} delay={0.2} className="mb-5 flex items-center gap-2">
            ...
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
              ...
              {/* Client card */}
              <Reveal y={0} x={20} duration={0.6} delay={0.5} className="lg:col-span-5 flex flex-col gap-4">
                <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-sm p-5">
                  <div className="flex items-center gap-3 mb-3 pb-3 border-b border-white/[0.08]">
                    ...
                    <div>
                      ...
                      <p className="text-[16px] font-bold text-white/90">Aeroporti di Roma</p>
                    </div>
                  </div>
            ...
            <Section className="mb-24">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5">
                {t.raw('results.metrics').map((m, i) => {
                  const MetricIcon = [Zap, Users, Clock][i] || Target;
                  return (
